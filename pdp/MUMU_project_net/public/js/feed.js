      ...
      header.innerHTML = `
        <div class="header-top-row">
          <div class="header-left">
            <a href="index.html" style="display: flex; width: 100%; height: 100%; align-items: center; justify-content: center;"><img src="assets/logos/mumu-logo.png" alt="MUMU Logo" style="max-width: 100%; max-height: 100%; object-fit: contain;"></a>
          </div>
