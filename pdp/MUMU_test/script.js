...
const trackA = [
  ...
  "‘이 연출은 못 하겠다’라고 느낀 이유는?",
  "지금까지 플랫폼 중 가장 좋았던 점 / 아쉬웠던 점은?",
  "신고·검열·제재 규정이 창작 심리에 준 영향은?",
  "연재 중 ‘내가 통제 못 한다’고 느낀 순간이 있었다면?",
  "플랫폼 수익 구조에 대한 만족/불만족 포인트는?",
  "작품이 더 성장하려면 어떤 기능이 필요했다고 느끼나요?",
  "피드형 읽기 방식 적용 시, 작품이 어떻게 재해석될까요?",
  "MUMU 같은 신규 플랫폼이 특별히 매력적일 조건은?",
];
...
const trackB = [
  ...
  "올릴 플랫폼을 결정하지 못한 이유는?",
  "기존 플랫폼이 나와 맞지 않는 이유는?",
  "창작 과정에서 가장 어려운 단계는?",
  "만들고 싶은 콘텐츠의 분위기와 형식은?",
  "SNS 업로드 경험이 있다면 어떤 느낌이었나요?",
  "공개할 때 가장 걱정되는 점은?",
  "형식 제한이 없다면 어떤 시도를 해보고 싶나요?",
  "피드형 노출 시 어떤 모습으로 보이고 싶나요?",
  "창작에 가장 필요한 환경은 무엇인가요?",
  "다른 창작자에게서 영향 받은 요소가 있나요?",
  "신고 기반 운영에 대해 어떤 인상을 받았나요?",
  "단계형 수익 구조가 동기부여가 되나요?",
  "MUMU가 첫 연재 플랫폼이 될 이유는?",
];
