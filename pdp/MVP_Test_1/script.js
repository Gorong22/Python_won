...
const questions = [
  {
    type: "radio",
    key: "q1",
    title: "Q1. 무무의 감성을 보고 어떤 느낌이 들었나요?",
  ...
  },
  {
    type: "radio",
    key: "q8",
    title: "Q8. 저장한 컷으로 무드보드를 만들 의향이 있나요?",
    options: [
      "자주 사용할 것 같다",
      "가끔 사용할 것 같다",
      "상황에 따라 다르다",
  ...
  },
  {
    type: "radio",
    key: "q11",
    title: "Q11. 가장 마음에 들었던 기능은?",
    options: ["추천 피드", "무드 기반 발견", "나만의 무드보드", "작가 소통"],
    required: true,
  },
  {
    type: "textarea",
